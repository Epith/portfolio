    ...
    <section className='grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative'>
        ...
        <div className="z-10">
            ...
            <p className='text-[#ADB7BE] mb-4 max-w-md'>
                {" "}
                I&apos;m currently looking for new opportunities, feel free to drop me a message!
            </p>
            <div className='socials flex flex-row gap-2'>
                <Link href="https://github.com/Epith">
                    <Image src={GithubIcon} alt="Github Icon"></Image>
                </Link>
                <Link href="https://www.linkedin.com/in/chiakweecheng/">
        ...
        <div>
            <form className='flex flex-col' onSubmit={handleSubmit}>
                <div className='mb-6'>
                    ...
                    required placeholder='alan.turing@gmail.com' 
                    className='bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5'></input>
                </div>
                <div className='mb-6'>
                    <label htmlFor='subject' className='text-white mb-2 block text-sm font-medium'>Subject</label>
                    <input name='subject' type='text' id='subject' 
                    required placeholder='Hello' 
                    className='bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5'></input>
                </div>
                <div className='mb-6'>
                    <label htmlFor='message' className='text-white block text-sm mb-2 font-medium'>Message</label>
                    <textarea name='message' id='message' placeholder='Leave your message here' className='bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5'>
                    </textarea>
                </div>
